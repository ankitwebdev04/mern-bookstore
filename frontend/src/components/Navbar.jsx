...
function  Navbar() {
  ...
  <input 
  type="text" className="grow outline-none dark:bg-slate-900 dark:text-white" placeholder="Search" />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
...
authUser?<Logout/>:
  <div className=''>
    <a className="bg-black text-white px-3 py-2 rounded-md bg-slate-800 duration-300 cursor-pointer"
